                        ...
                        Container(
                          child: Wrap(
                            children: [
                              chip(
                                  text:
                                      "Rupping technological college of engineer"),
                              chip(
                                text: "Apple seed academy",
                              ),
                              chip(
                                text: "Qa experts college",
                              ),
                            ],
                          ),
                        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage(_swipeItems[index].content.imageURl),
          fit: BoxFit.cover,
