                ...
                children: [
                 InkWell(
                   ...
                   child: Container(
                     ...
                     child: Text("Send",style: TextStyle(fontSize: width*0.028),),
                   decoration: BoxDecoration(
                     boxShadow: [
                       BoxShadow(
                         ...
                         spreadRadius: 1.5,
                         blurRadius: 3,
                         offset: Offset(0, 2.2), // changes position of shadow
                       ),
                     ],
                     color: Colors.white,
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text("Submit",style: TextStyle(fontSize: width*0.028,color: AppColors.goldColor),),
                      decoration: BoxDecoration(
                        boxShadow: [
                          BoxShadow(
